...
export const PRODUTOS_ESTOQUE = [
  { id: 1, nome: "Bafômetro Phoebus Premium Edition XL", codigo: "1", unidade: "UN", preco: 250, saldo: 10, situacao: "A" as const },
  { id: 2, nome: "Tubo descartável", codigo: "P2", unidade: "CX", preco: 5, saldo: 100, situacao: "A" as const },
  { id: 3, nome: "Bocal", codigo: "163", unidade: "UN", preco: 3.5, saldo: 0, situacao: "A" as const },
  { id: 4, nome: "Sensor antigo", codigo: "900", unidade: "PC", preco: 80, saldo: -2, situacao: "I" as const },
  { id: 5, nome: "Kit calibração", codigo: "4", unidade: "KT", preco: 1200, saldo: 3, situacao: "I" as const },
  { id: 6, nome: "Brinde", codigo: "77", unidade: "UN", preco: 0, saldo: 50, situacao: "A" as const },
];
