...
const Configuracoes: React.FC = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white dark:bg-surface shadow-sm rounded-xl p-6 mb-6 transition-colors">
      ...
      <div className="bg-white dark:bg-surface rounded-xl shadow p-4 transition-colors">
            ...
            <div className="flex-1">
              ...
              {cfg.chave === "ANIMACAO_META" ? (
                ...
                <input
                  ...
                  className="w-full overflow-x-auto whitespace-nowrap p-3 text-sm rounded-lg border border-blue-300 dark:border-blue-700 bg-blue-50 dark:bg-surface text-gray-800 dark:text-gray-200 font-mono shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white dark:focus:bg-surface transition"
                  spellCheck={false}
                />
              ) : (
