...
const Sidebar: React.FC<SidebarProps> = ({ collapsed = false }) => {
  ...
  return (
    <aside
      className={`hidden lg:flex ${collapsed ? "w-16" : "w-56"} bg-white dark:bg-surface text-gray-900 dark:text-gray-100 shadow sticky top-0 flex-col transition-all duration-300`}
    >
